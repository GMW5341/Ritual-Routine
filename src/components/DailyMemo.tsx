    ...
    <div className="bg-[#272c38]/30 border border-[#313744]/40 rounded-xl p-4 space-y-3">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-white/70">{dateLabel} 메모</span>
        </div>
        {hasMemo && !editing && (
            ...
            {confirmDelete ? (
              <div className="flex items-center gap-1">
                ...
                <button
                  ...
                  className="px-2 py-1 text-[10px] text-white/60 hover:bg-white/5 rounded-md transition-colors"
                >
                  취소
                </button>
              </div>
              ...
              <button
                ...
                className="px-2 py-1 text-[10px] text-white/60 hover:text-red-400 hover:bg-white/5 rounded-md transition-colors"
              >
                삭제
              </button>
            )}
