      ...
      <div className="max-w-md w-full space-y-16">
        ...
        <div className="flex items-center justify-center gap-3 text-white/20">
          <div className="flex flex-col items-center gap-1">
            ...
            <span className="text-[10px] tracking-wider">BODY</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            <span className="text-[10px] tracking-wider">MIND</span>
          </div>
          <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1} viewBox="0 0 24 24">
            <path strokeLinecap="round" d="M5 12h14m-4-4 4 4-4 4" />
          </svg>
          <div className="flex flex-col items-center gap-1">
            <span className="text-2xl">⚡</span>
            <span className="text-[10px] tracking-wider">DECISION</span>
          </div>
          <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1} viewBox="0 0 24 24">
            <path strokeLinecap="round" d="M5 12h14m-4-4 4 4-4 4" />
          </svg>
          <div className="flex flex-col items-center gap-1">
            <span className="text-2xl">🌱</span>
            <span className="text-[10px] tracking-wider">LIFE</span>
          </div>
        </div>
      </div>
    </div>
