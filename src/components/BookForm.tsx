  ...
  return (
    <div className="bg-[#272c38]/50 border border-[#313744]/60 rounded-xl p-5 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button onClick={onClose} className="p-1 text-white/40 hover:text-white/65 transition-colors">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <div>
          <label className="text-[10px] text-white/50 uppercase tracking-wider">제목 *</label>
          <input
            type="text"
            value={title}
        ...
        <div>
          <label className="text-[10px] text-white/50 uppercase tracking-wider">저자</label>
          <input
            type="text"
            value={author}
        ...
        <div className="flex gap-3">
          <div className="flex-1">
            <label className="text-[10px] text-white/50 uppercase tracking-wider">총 페이지</label>
            <input
              type="number"
              value={totalPages}
          ...
          <div className="flex-1">
            <label className="text-[10px] text-white/50 uppercase tracking-wider">상태</label>
            <select
              value={status}
